...
const messageCtrl = {
    createMessage: async (req, res) => {
        try {
            ...
            // to update if either sender or recipient is sending message
    ...
    getMessages: async (req, res) => {
        try {
            //to get message of both sender and reciever
            ...
            //     // messages.map(msg => {
            //     //     let bytes = CryptoJS.AES.decrypt(msg.text, 'secret key 123');
